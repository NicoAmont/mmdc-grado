          ...
          <div className='w-11/12 h-screen'>
            <div className="bg-bgr flex  2xl:flex-row items-center  text-base w-full h-16 2xl:h-28  2xl:px-5  justify-between max-w-7xl">
                ...
                <Link  href="/" passHref>
                  ...
                  <div>
                  <img className='absolute w-80 top-1/2 left-1/3 transform -translate-y-1/2 bottom-0 '  src="/fotobanner1.png"/>

                  </div>
              
            
            
            <img className='top-52 left-16 absolute'  src="/izqbanner.png" layout='fill' objectFit='cover' objectPosition='center' alt="" />
            <img className='top-32 right-16 absolute'  src="/derbanner.png" layout='fill' objectFit='cover' objectPosition='center' alt="" />
